...
tab0, tab1, tab2, tab3, tab4 = st.tabs(['Geral', 'Etnia', 'Gênero', 'Desempenho de Notas', 'Desempenho em Materias'])

with tab0:
    st.write('### Visão Geral do Desempenho dos Estudantes')
    ...
    plt.grid()
    st.pyplot() #plota os gráficos no streamlit
...
with tab1:
    ...
    """
    Analisando o grupo de etnia dos estudantes, o grupo C representa a maior proporção dos estudantes que representam 31.9% do total
    """


with tab2:
    st.write('### Total de Estudantes por Gênero')
    ...
    st.pyplot(f)
    st.write('O gênero feminino é predominante na base de estutantes, totalizando 51% da amostra')
...
with tab3:
    ...
    st.write('Estatísticas básicas para o grupo feminino: ')
...
with tab4:
    st.write('Análise de Desempenho em Notas por Disciplina')
